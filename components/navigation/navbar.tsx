...
export function Navbar() {
  return (
    <>
      <header className="fixed left-1/2 top-0 z-50 flex h-24 w-full max-w-360 -translate-x-1/2 items-center justify-between gap-4 rounded-none bg-background px-4 shadow-sm">
...
export function NavbarMobile({ showFilterButton }: NavbarMobileProps) {
  ...
  return (
    <>
      <header className="fixed left-1/2 top-0 z-50 flex h-33 w-full max-w-360 -translate-x-1/2 flex-col gap-4 bg-background px-4 py-4 shadow-sm">
